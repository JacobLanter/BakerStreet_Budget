...
from .utils import format_milliunits
...
class Category(models.Model):
    ...
    # Returns a readable label for each category
    def __str__(self):
    ...
    def budgeted_display(self):
        return format_milliunits(self.budgeted)

    @property
    def activity_display(self):
        return format_milliunits(self.activity)

    @property
    def goal_target_display(self):
        return format_milliunits(self.goal_target)
